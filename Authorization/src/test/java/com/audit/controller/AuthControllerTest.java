...
public class AuthControllerTest {
	...
	public void generateJwtTest(){
		...
		request.setUsername("akhil");
		request.setPassword("akhil1137");
		
		// making projectManager
		projectManager= new ProjectManager(1, "Akhilesh reddy", "akhil", "akhil1137", "Project1");
	...
	public void validateJwt(){
		...
		authenticationResponse = new AuthenticationResponse("Akhilesh reddy", "Project1", true);
